...
interface Computed extends ComputedOptions {
  user: ComputedGetter<User | undefined>;
  name: ComputedGetter<string>;
  availableTextLinks: ComputedGetter<HeaderTextLink[]>;
}
...
export default defineComponent<ComponentPropsOptions<Props>, unknown, unknown, Computed, Methods>({
  name: 'MemberMenu',
  components: {
    HeaderTextLinkButton,
    ProfileImage,
