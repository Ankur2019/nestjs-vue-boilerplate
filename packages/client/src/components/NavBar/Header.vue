...
interface Computed extends ComputedOptions {
  isMobile: ComputedGetter<boolean>;
  user: ComputedGetter<null | User>;
  navigations: ComputedGetter<Navigation[]>;
  availableNavigations: ComputedGetter<Navigation[]>;
}

export default defineComponent<ComponentPropsOptions, unknown, unknown, Computed, MethodOptions>({
  name: 'Header',
  components: {
    MemberMenu,
    MemberMobileMenu,
